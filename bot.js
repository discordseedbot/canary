...
client.on("message", async message => {
  ...
  if (command === "invite") {
    syncStats()
      message.channel.send(require('./modules/basic.js').invite(message.author.username));
  }  
  if (command === "help") {
    syncStats()
      message.channel.send(require('./modules/basic.js').help(message.author.username));
  }
  if (command === "support") {
    syncStats()
      message.channel.send(require('./modules/basic.js').support(message.author.username));
  }
  if (command === "patreon") {
    syncStats()
      message.channel.send(require('./modules/basic.js').patreon(message.author.username));
  }
  if (command === "info") {
    syncStats()
